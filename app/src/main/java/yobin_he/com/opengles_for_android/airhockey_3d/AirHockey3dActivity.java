package yobin_he.com.opengles_for_android.airhockey_3d;
 ...
 * 用于进行曲棍球游戏
 */
public class AirHockey3dActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(OpenglesHelper.isSupportsVersion(context,OpenglesHelper.OPENGL_VERSION)){
            ...
            surfaceView.setRenderer(new AirHockey3dRender(context));
            isRenderSet = true;
        }else {
