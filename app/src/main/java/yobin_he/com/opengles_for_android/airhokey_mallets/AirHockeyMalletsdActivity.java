...
import yobin_he.com.opengles_for_android.airhockey_textured.AirHockeyTexturedRender;
import yobin_he.com.opengles_for_android.utils.OpenglesHelper;

/**
 * 用于进行曲棍球游戏
 */
public class AirHockeyMalletsdActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(OpenglesHelper.isSupportsVersion(context,OpenglesHelper.OPENGL_VERSION)){
            ...
            surfaceView.setRenderer(new AirHockeyMalletsRender(context));
            isRenderSet = true;
        }else {
